import{a as u}from"./chunk-OEMQRESF.js";import{u as c,v as p}from"./chunk-PEALLUVR.js";import"./chunk-YB4KKQIU.js";import"./chunk-4WPPCIBR.js";import"./chunk-ISSYNZCZ.js";import{Bb as e,Pa as o,_a as m,jb as s,nb as n,ob as t,pb as i,ra as r}from"./chunk-SY7OXONI.js";import"./chunk-EQDQRRRY.js";var g=class l{constructor(){}beforeCode=r(`type DB = "MySQL" | "Redis" | "Neo4j";
...
`);static \u0275fac=function(a){return new(a||l)};static \u0275cmp=m({type:l,selectors:[["app-solid-open-closed"]],decls:68,vars:4,consts:[[1,"mb-4","mt-2"],[1,"hljs-attr"],[1,"icon-red"],[3,"code","language"],[1,"icon-green"]],template:function(a,d){a&1&&(n(0,"h1"),e(1,"O - Open/Closed Principle (OCP)"),t(),n(2,"div",0)(3,"h6"),e(4,"Original Definition"),t(),e(5," Software entities should be open for extension, but closed for modification."),i(6,"br")(7,"br"),n(8,"h6"),e(9,"Simple Definition"),t(),e(10,` The Open/Closed Principle means that once you write a piece of code, you should be able to add new functionality to it without changing the existing code.\xA0\xA0It promotes extending the behavior of software rather than altering it, ensuring that changes don't break existing functionality.
...
maintain and extend.`),i(29,"br")(30,"br"),e(31,` After implementing OCP, the code is refactored to use interfaces and separate
...
implement these methods according to their specific behavior.`),i(47,"br")(48,"br"),e(49,` This approach adheres to the Open/Closed Principle because the
...
design.`),i(56,"br")(57,"br"),n(58,"mat-icon",2),e(59,"close_small"),t(),n(60,"b"),e(61,"Before following OCP:"),t(),i(62,"app-code-highlight",3),n(63,"mat-icon",4),e(64,"check_small"),t(),n(65,"b"),e(66,"After following OCP:"),t(),i(67,"app-code-highlight",3)),a&2&&(o(62),s("code",d.beforeCode)("language","typescript"),o(5),s("code",d.afterCode)("language","typescript"))},dependencies:[u,p,c],encapsulation:2})};export{g as SolidOpenClosedComponent};
