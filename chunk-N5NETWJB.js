import{h as g}from"./chunk-5KLKH5YB.js";import{Eb as p,Pb as e,ab as f,fb as s,ja as l,lb as d,nb as c,tb as m,ub as n,vb as t,wb as r}from"./chunk-Y6T5JIJL.js";var x=()=>[import("./chunk-DXP7GUXA.js").then(o=>o.CodeHighLightComponent)];function h(o,a){if(o&1&&r(0,"app-code-highlight",4),o&2){let i=p();m("code",i.beforeCode)("language","typescript")}}function S(o,a){o&1&&(n(0,"span"),e(1,"Loading..."),t())}function y(o,a){if(o&1&&r(0,"app-code-highlight",4),o&2){let i=p();m("code",i.afterCode)("language","typescript")}}function P(o,a){o&1&&(n(0,"span"),e(1,"Loading..."),t())}var u=class o{constructor(){}beforeCode=l(`interface VPNConnection {
  useL2TP: () => void;
  useOpenVPN: () => void;
  useV2Ray: () => void;
  useShadowsocks: () => void;
...
`);static \u0275fac=function(i){return new(i||o)};static \u0275cmp=f({type:o,selectors:[["app-solid-interface-segregation"]],decls:89,vars:0,consts:[[1,"mb-4","mt-2"],[1,"hljs-attr"],[1,"icon-red"],[1,"icon-green"],[3,"code","language"]],template:function(i,w){i&1&&(n(0,"h1"),e(1,"I - Interface Segregation Principle (ISP)"),t(),n(2,"div",0)(3,"h6"),e(4,"Original Definition"),t(),e(5," No code should be forced to depend on methods it does not use."),r(6,"br")(7,"br"),n(8,"h6"),e(9,"Simple Definition"),t(),e(10,` The ISP means that clients should not be forced to implement methods they don't use.\xA0\xA0It's like saying, "Don't make people take things they don't need."
...
encapsulation and separation of concerns.`),r(71,"br")(72,"br"),n(73,"mat-icon",2),e(74,"close_small"),t(),n(75,"b"),e(76,"Before following ISP:"),t(),s(77,h,1,2)(78,S,2,0),d(79,77,x,null,78),c(0,-1),n(81,"mat-icon",3),e(82,"check_small"),t(),n(83,"b"),e(84,"After following ISP:"),t(),s(85,y,1,2)(86,P,2,0),d(87,85,x,null,86),c(0,-1))},dependencies:[g],styles:[".icon-red[_ngcontent-%COMP%]{color:red;vertical-align:bottom}.icon-green[_ngcontent-%COMP%]{color:green;vertical-align:bottom}"]})};export{u as a};
